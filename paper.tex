...
%% Written by Adam Wright, 26 February 2004
%%
...
\title{Ontario Institute for Cancer Research, University of Toronto.}

%% Notice placement of commas and superscripts and use of &
%% in the author list

\author{Adam Wright$^{1,2}$, Bauthor$^2$ \& Lincoln Stein$^2$}
...
\begin{affiliations}
 \item Ontario Institute for Cancer Research
